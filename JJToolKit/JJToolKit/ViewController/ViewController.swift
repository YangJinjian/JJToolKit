...
//        let model = JJAdModel(videoName: "test_video1.mp4", startTime: startTime, endTime: endTime, canSkip: true)
//        JJAdLauncher.shared.launch(mediaModel: model)
    }
